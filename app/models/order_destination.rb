class OrderDestination
  ...
  with_options presence: true do
    validates :user_id
    validates :item_id
    validates :postal_code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/i, message: 'is invalid. Include hyphen(-)' }
  ...
  def save
    ...
    Destination.create(postal_code: postal_code, ship_from_id: ship_from_id, city: city, address: address,
